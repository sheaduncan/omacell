...
const DE_DE: LocaleInfo = LocaleInfo {
    lcid: 0x0407,
    bcp47: "de-DE",
    separators: LocaleSeparators { decimal: ',', thousands: '.', list: ';' },
    date_order: DateOrder::Dmy,
    am: "AM",
    pm: "PM",
    months_full: [
...
const SV_SE: LocaleInfo = LocaleInfo {
    ...
    days_full: ["söndag", "måndag", "tisdag", "onsdag", "torsdag", "fredag", "lördag"],
...
const JA_JP: LocaleInfo = LocaleInfo {
    ...
    days_full: ["日曜日", "月曜日", "火曜日", "水曜日", "木曜日", "金曜日", "土曜日"],
...
const ZH_CN: LocaleInfo = LocaleInfo {
    ...
    months_full: ["1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月", "12月"],
    months_abbr: ["1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月", "12月"],
    days_full: ["星期日", "星期一", "星期二", "星期三", "星期四", "星期五", "星期六"],
...
const KO_KR: LocaleInfo = LocaleInfo {
    ...
    am: "오전",
    pm: "오후",
    months_full: ["1월", "2월", "3월", "4월", "5월", "6월", "7월", "8월", "9월", "10월", "11월", "12월"],
    months_abbr: ["1월", "2월", "3월", "4월", "5월", "6월", "7월", "8월", "9월", "10월", "11월", "12월"],
    days_full: ["일요일", "월요일", "화요일", "수요일", "목요일", "금요일", "토요일"],
