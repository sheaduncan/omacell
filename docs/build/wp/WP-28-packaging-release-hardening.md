...
- GUI completion pass: resolve WP-16's recorded release gaps (multi-window decision/implementation, painted split panes, per-cell family/fallback fidelity and shaping-cache profiling, clickable status segments), consume WP-17 clipboard/fill/atomic drag commands and WP-18 conditional-format overlays, and exercise each path in the keyboard/mouse/a11y walkthroughs.
