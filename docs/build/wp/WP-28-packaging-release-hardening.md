...
- GUI completion pass: resolve WP-16's remaining release gaps (multi-window decision/implementation, painted split panes, per-cell family/fallback fidelity and shaping-cache profiling, clickable status segments), consume WP-18 conditional-format overlays, and exercise each path in the keyboard/mouse/a11y walkthroughs. WP-17 clipboard/fill/atomic drag integration is already covered by pre-WP-28 keyboard and mouse regressions.
