...
- Repo files: `AGENTS.md` (from this bundle), `CLAUDE.md` containing `@AGENTS.md`, `docs/spec/omacell-design-spec.md`, `docs/build/` (this bundle), `docs/adr/0001…0006` seeded from spec §11.2 with status *proposed*/*decided*, `LICENSE` (MIT), `README.md`, `CHANGELOG.md`, `reports/README.md`.
